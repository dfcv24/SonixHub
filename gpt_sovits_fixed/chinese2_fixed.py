...
pinyin_to_symbol_map = {
    ...
    for line in open(os.path.join(current_file_path, "../GPT-SoVITS/GPT_SoVITS/text/opencpop-strict.txt")).readlines()
}
...
if is_g2pw:
    ...
    g2pw = G2PWPinyin(
        model_dir="GPT-SoVITS/GPT_SoVITS/text/G2PWModel",
