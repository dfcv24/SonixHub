...
old_file_path = os.path.join(current_file_path, "../GPT-SoVITS/GPT_SoVITS/text")
CMU_DICT_PATH = os.path.join(old_file_path, "cmudict.rep")
CMU_DICT_FAST_PATH = os.path.join(old_file_path, "cmudict-fast.rep")
CMU_DICT_HOT_PATH = os.path.join(old_file_path, "engdict-hot.rep")
CACHE_PATH = os.path.join(old_file_path, "engdict_cache.pickle")
NAMECACHE_PATH = os.path.join(old_file_path, "namedict_cache.pickle")
